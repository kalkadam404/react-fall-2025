...
export function About() {
  return (
    <div className=" flex-1 overflow-y-scroll p-8 max-sm:ml-0">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p>
            ...
            technologies, focusing on clean code, usability, and performance. My
            goal is to craft applications that people enjoy using every day.
          </p>
        </div>
      </div>
